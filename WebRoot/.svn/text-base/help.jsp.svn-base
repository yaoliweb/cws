...
<html>
	...
	<f:view>
	<title><h:outputText value="#{msgs.help}"></h:outputText></title>
		<body>
			<center>
				<h:form>
				<table id="table1">
								...
								<f:facet name="header">
									<h:panelGroup>
										<table>
											<tr>
												<td>
													<h:outputText value="#{msgs.help}" styleClass="panel-title"></h:outputText>
												</td>
											</tr>
										</table>
									</h:panelGroup>
								...
								<table>
									<tr>
										<td style="Text-Align: left" valign="middle">
											<h2 align="center">
												<h:outputText value="#{msgs.help1}"></h:outputText><br/>
											</h2>
										</td>
									</tr>
								</table>
