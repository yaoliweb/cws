							...
							<f:subview id="content">
								<table id="table2">
									<tr>
										...
										　　　<h:outputText value="#{sewageBean.errorMess}"/>　　　　　　　　　　　　　　　　　　　　　　　　　
									    <h:outputText value="时间设置（分钟）："/>
									    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
										<h:inputText value="#{sewageBean.timeControl}" size="3"/>
										　　
									...
									<rich:panel style="width:800px;height:521px;" id="showcontent">
										<f:facet name="header">
												...
												<table>
													<tr>
														<td>
															<h:outputText value="#{sewageBean.areaSelectName}站点预警列表"
												...
												<rich:dataTable id="sewageTable" rows="16"
													value="#{sewageBean.warnSearchList}" var="sewage"
													...
													<rich:column>
														...
														<h:outputText value="#{sewage.date}"/>
													</rich:column>
