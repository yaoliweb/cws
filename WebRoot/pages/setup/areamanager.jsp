...
<html>
	<head>
		...
		<script type="text/javascript">
			...
			function setAllChecked() {
				var oTable = document.all['form1:content:areaTable'];
	...
	<f:view>
		<head>
			<title><h:outputText value="县区管理" /></title>
		</head>
		<body>
			<center>
				<h:form id="form1">
					<h:inputHidden id="delDataIDStr"
						value="#{areaBean.delDataIDStr}" />	
					<table>
						<tr>
												...
												<f:facet name="header">
													<h:panelGroup>
														<table width="98%">
															<tr>
																<td width="75%">
																	<h:outputText value="区县管理" styleClass="panel-title"/>
																</td>
															</tr>
														</table>
													</h:panelGroup>
												</f:facet>
												<rich:dataTable id="areaTable" rows="16"
													value="#{areaBean.wraplistDataModel}" var="area"
													...
													<!-- 区县ID -->
													 <rich:column >
		                                            	<h:outputText value="#{area.areaId}" style="display:none" />
													</rich:column>
													<!-- 区县名称 -->
													<rich:column sortBy="#{area.name}">
														<f:facet name="header">
														    <h:outputText value="区县名称"/>
														</f:facet>
														<h:commandLink action="#{areaBean.areaEditAction}">
															<h:outputText value="#{area.name}"/>
															<f:param name="areaId" value="#{area.areaId}"/>
														</h:commandLink>
													</rich:column>																										
													
													<!-- 负责人 -->
													<rich:column  sortBy="#{area.principal}">
														<f:facet name="header">
														    <h:outputText value="负责人"/>
														</f:facet>
														<h:outputText value="#{area.principal}"/>
													</rich:column>
													
													<!-- 联系电话 -->
													<rich:column  sortBy="#{area.tel}">
														<f:facet name="header">
														    <h:outputText value="联系电话"/>
														</f:facet>
														<h:outputText value="#{area.tel}"/>
													</rich:column>
													...
													<tr>
														...
														<td width="6%" align="center">
															<h:commandButton value="#{msgs.delete}"
																...
																action="#{areaBean.deleteByIDs}" style="height: 25px; width: 40px">
															</h:commandButton>
														</td>
														<td width="6%" align="center">
															<h:commandButton value="#{msgs.add}" action="#{areaBean.areaAddAction}"
														...
														<!-- 分页组件  -->
														<td width="75%">
												            <rich:datascroller for="areaTable" maxPages="10" align="right">
														        <f:facet name="first">
