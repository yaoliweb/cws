					...
					<h:panelGrid columns="2">
						...
						<rich:panel style="width:770px;height:1250px">												
								<birt:parameterPage
								    ...
								    isCustom="true"
								    pattern="frameset"
								    reportDesign="reports/areayears.rptdesign"
								    target="myiframe"
								    width="770"
								    height="50"
								    format="html"
									...
									<table id="canshu" align="center">
										<tr >
											<td align="center">
												<h:outputText value="#{msgs.inputdate}"/><birt:paramDef id="param" name="year"/>
											</td>
											<td align="center">
												<h:outputText value="请选择地区"/><birt:paramDef id="areaSelect" name="area"/>
											</td>
											<td align="center">
